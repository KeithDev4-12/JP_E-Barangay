...
type
  TUBarangayID = class(TForm)
    ...
    fdqryHistoryDetailsID_2: TIntegerField;
    fdqryHistoryDetailsStatus: TStringField;
    fdqryHistoryDetailsKindTable: TStringField;
    fdqryHistoryDetailsBrgyID_1: TStringField;
    fdqryHistoryDetailsFKID: TIntegerField;
